...
drive_command.trans_v = 0.1 #go 0.25m in 1s
drive_command.angular_v = 0.0

turn_command = mbot_motor_command_t()
turn_command.trans_v = 0.0 #go 0.25m in 1s
turn_command.angular_v = math.pi/4
...
drive_command = mbot_motor_command_t()
drive_command.trans_v = 0.45 #go 0.25m in 1s
drive_command.angular_v = 0.0
