...
class mbot_wheel_ctrl_t(object):
    __slots__ = ["utime", "left_motor_pwm_cmd", "right_motor_pwm_cmd", "left_motor_vel_cmd", "right_motor_vel_cmd", "left_motor_vel", "right_motor_vel"]
    ...
    def __init__(self):
        self.utime = 0
        self.left_motor_pwm_cmd = 0.0
        self.right_motor_pwm_cmd = 0.0
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">qffffff", self.utime, self.left_motor_pwm_cmd, self.right_motor_pwm_cmd, self.left_motor_vel_cmd, self.right_motor_vel_cmd, self.left_motor_vel, self.right_motor_vel))
    ...
    def _decode_one(buf):
        ...
        self.utime, self.left_motor_pwm_cmd, self.right_motor_pwm_cmd, self.left_motor_vel_cmd, self.right_motor_vel_cmd, self.left_motor_vel, self.right_motor_vel = struct.unpack(">qffffff", buf.read(32))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6c450f4807288b03) & 0xffffffffffffffff
