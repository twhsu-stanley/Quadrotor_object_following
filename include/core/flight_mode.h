...
typedef enum flight_mode_t
{
    ...
    /**
     * Tracking: holds constant altitude (may need to incorporate range finder to determine height)
     ...
     * 
     * Sentry: holds constant altitude (may need to incorporate range finder to determine height)
     * processes lcm_message describing location of object of interest in the iphone camera frame
